...
<svelte:head>
	<title>Lucas Ng</title>
</svelte:head>

<BgGridEffect />

<section class="relative flex h-screen">
	<div class="m-auto rounded-2xl px-10 !pb-0 pt-14">
		<div class="group sm:flex sm:flex-row-reverse">
			...
			<div class="space-y-8">
				<div class="pb-4">
					<h1
						class="whitespace-nowrap font-display text-4xl underline decoration-orange-500 decoration-wavy underline-offset-8"
					>
						Hiya, I'm Lucas
					</h1>
				</div>
				<div class="text-md space-y-4 rounded-xl md:text-lg">
