...
<svelte:head>
	...
	<meta property="og:title" content={`{title} | Lucas Ng`} />
	<meta name="twitter:title" content={`{title} | Lucas Ng`} />
...
<section class="relative flex min-h-screen p-7 pt-40">
	<div class="mx-auto space-y-12 sm:w-3/4 lg:w-1/2">
		<div class="text-left">
			...
			<h2 class="mt-2 inline-block bg-slate-50 text-lg !leading-relaxed text-gray-500">
				{subtitle}
			</h2>
